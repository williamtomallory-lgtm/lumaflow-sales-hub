 ...
 */
export type View = "knowledge" | "agents" | "assistant" | "salesAssistant" | "followup";
...
export const VIEW_META: Record<View, { eyebrow: string; title: string; subtitle: string }> = {
  ...
  agents: { eyebrow: "本地 Agent · 微信 Agent", title: "智能体", subtitle: "为本地 Agent 设置主要任务、工作间和知识文件；微信 Agent 单独管理。" },
