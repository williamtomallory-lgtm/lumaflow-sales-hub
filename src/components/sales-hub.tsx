    ...
    <div className={`app-shell${isChat ? " chat-shell" : ""}`}>
      ...
      <main className="main-area">
        ...
        <section className={isChat ? "chat-page-wrap" : "page-wrap"}>
          ...
          {view === "agents" && <AgentManagement onToast={showToast} onOpenWork={(agentId) => { try { localStorage.setItem("lumaflow.agent.id", agentId); } catch { /* preference is optional */ } navigate("salesAssistant"); }} />}
